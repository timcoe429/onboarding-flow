...
function docket_handle_website_vip_submission() {
    ...
    if ($sent) {
        ...
        $site_creation_response = create_site_via_api($_POST, 'website-vip');
        
        // Trigger NS Cloner integration (if available) - FALLBACK
        do_action('docket_after_form_submission', $_POST, 'website-vip');
        ...
        if (class_exists('DocketClientPortal')) {
            ...
            if ($docket_client_portal) {
                ...
                $portal_url = $docket_client_portal->create_client_project($_POST, 'website-vip', $new_site_url);
            }
        }
